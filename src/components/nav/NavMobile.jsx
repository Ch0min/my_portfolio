        ...
        <div>
            <nav className="nav__mobile">
                ...
                <ul>
                    ...
                    {/*                             className={activeNav === "#" || activeNav === "#blogcards" ? "active" : ""}><AiOutlineHome/></a></li>*/}
                    ...
                    <li className="nav__link"><a href="#experience" onClick={() => setActiveNav("#experience")}
                                                 className={activeNav === "#experience" ? "active" : ""}><BsCodeSlash/></a>
                    </li>
                    <li className="nav__link"><a href="#projects" onClick={() => setActiveNav("#projects")}
                                                 className={activeNav === "#projects" ? "active" : ""}><BsClipboardCheck/></a>
                    </li>
                    <li className="nav__link"><a href="#contact" onClick={() => setActiveNav("#contact")}
                                                 className={activeNav === "#contact" ? "active" : ""}><BsChatText/></a>
                    </li>
                    <div id="nav__ender"></div>
                </ul>
            </nav>
            {activeNav !== null && (
                <div className="nav__top-button-mobile" onClick={scrollToTop}>
                    <AiOutlineArrowUp/>
                </div>
            )}
        </div>
